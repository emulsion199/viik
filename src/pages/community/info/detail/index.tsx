...
const InfoDetail = () => {
   ...
   return (
      mount && (
         <SecondaryTemplate>
            <div className='center column w-screen space-y-20 py-20'>
               <span className='text-h1 font-medium'>VIIK 홈페이지 방문 공지</span>
               <span className='text-p2 font-medium w-[600px]'>
               ...
               <span className='w-[680px] h-[817px] bg-bg-default border'></span>
               <span className='text-p2 font-medium w-[600px]'>
               ...
               <span className='text-h1 font-medium'>관련 게시물</span>
               <div className='column space-y-10 w-[576px]'>
